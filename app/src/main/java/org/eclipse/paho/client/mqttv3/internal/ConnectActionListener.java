...
/**
  ...
  public void onFailure(IMqttToken token, Throwable exception) {
    ...
    if(!reconnect){
      ...
      client.startReconnectCycle();
    }
  }

  @Override
  public void onIntermediate(IMqttToken asyncActionToken) {
    if(userCallback!=null) userCallback.onIntermediate(asyncActionToken);
    if(mqttCallbackExtended!=null)mqttCallbackExtended.startingConnect(reconnect);
  }
