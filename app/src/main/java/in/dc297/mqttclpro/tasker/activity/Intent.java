...
public final class Intent
{
     ...
     */
    public static final String EXTRA_TOPIC = "in.dc297.mqttclpro.tasker.activity.Intent.EXTRA_TOPIC"; //$NON-NLS-1$
    public static final String EXTRA_BROKER_ID = "in.dc297.mqttclpro.tasker.activity.Intent.EXTRA_BROKER_ID"; //$NON-NLS-1$
    public static final String EXTRA_MESSAGE = "in.dc297.mqttclpro.tasker.activity.Intent.EXTRA_MESSAGE"; //$NON-NLS-1$
    public static final String EXTRA_TOPIC_VAR = "in.dc297.mqttclpro.tasker.activity.Intent.EXTRA_TOPIC_VAR"; //$NON-NLS-1$
